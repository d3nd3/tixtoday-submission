...
To improve performance I would ensure that component re-renders are never too costly and occur never too frequently.  I would ensure as much content as possible is cached, Resources/images are compressed and use different sized images for different screen sizes.
